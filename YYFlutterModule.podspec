#
# Be sure to run `pod lib lint YYFlutterModule.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'YYFlutterModule'
  s.version          = '0.1.0'
  s.summary          = 'A short description of YYFlutterModule.'
...
TODO: Add long description of the pod here.
  ...
  s.ios.vendored_frameworks = "flutter_module/.ios/Flutter/App.framework"
end
